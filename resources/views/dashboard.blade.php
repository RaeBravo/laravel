<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between bg-gradient-to-r from-yellow-300 via-yellow-400 to-blue-500 px-6 py-4 rounded-t-lg shadow">
            <h2 class="text-2xl font-extrabold text-black">KAKUPALAN NI MALEN</h2>
            <span class="text-sm text-white opacity-80">Welcome back!</span>
        </div>
    </x-slot>
s
    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8" >
        ...
        <div id="editDrawer" class="hidden transition-all duration-300 bg-white shadow rounded-lg p-6 mb-8">
            <h3 class="text-lg font-semibold mb-4">✏️ Edit Bookings</h3>
